...
namespace LuzyceApi.Db.AppDb.Migrations
{
    ...
    [Migration("20240923162421_addRemarksToPP")]
    partial class addRemarksToPP
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("LuzyceApi.Db.AppDb.Models.Document", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            CreatedAt = new DateTime(2024, 9, 23, 18, 24, 21, 218, DateTimeKind.Local).AddTicks(2026),
                            DocNumber = 1,
                            ...
                            StatusId = 1,
                            UpdatedAt = new DateTime(2024, 9, 23, 18, 24, 21, 218, DateTimeKind.Local).AddTicks(2054),
                            WarehouseId = 1,
                            Year = 2023
                        },
                        new
                        {
                            Id = 2,
                            CreatedAt = new DateTime(2024, 9, 23, 18, 24, 21, 218, DateTimeKind.Local).AddTicks(2059),
                            DocNumber = 1,
                            DocumentsDefinitionId = 2,
                            Number = "P/0001/ZP/2024",
                            OperatorId = 1,
                            StatusId = 1,
                            UpdatedAt = new DateTime(2024, 9, 23, 18, 24, 21, 218, DateTimeKind.Local).AddTicks(2060),
                            WarehouseId = 2,
                            Year = 2024
                        });
                });
            ...
            modelBuilder.Entity("LuzyceApi.Db.AppDb.Models.DocumentPositions", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            QuantityToImprove = 0,
                            Remarks = "",
                            StartTime = new DateTime(2024, 9, 23, 18, 24, 21, 218, DateTimeKind.Local).AddTicks(2400)
                        },
                        new
                        {
                            Id = 2,
                            ...
                            QuantityToImprove = 0,
                            Remarks = "Test",
                            StartTime = new DateTime(2024, 9, 23, 18, 24, 21, 218, DateTimeKind.Local).AddTicks(2405),
            ...
            modelBuilder.Entity("LuzyceApi.Db.AppDb.Models.LampshadeNorm", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            VariantId = 1,
                            WeightBrutto = 3.0,
                            WeightNetto = 0.45000000000000001
                        });
                });
            ...
            modelBuilder.Entity("LuzyceApi.Db.AppDb.Models.OrderForProduction", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = 1,
                            CustomerId = 1,
                            Date = new DateTime(2024, 9, 23, 18, 24, 21, 218, DateTimeKind.Local).AddTicks(2254),
                            Number = "1",
                            OriginalNumber = "1"
                        });
                });
            ...
            modelBuilder.Entity("LuzyceApi.Db.AppDb.Models.User", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            CreatedAt = new DateTime(2024, 9, 23, 18, 24, 21, 108, DateTimeKind.Local).AddTicks(7656),
                            Email = "admin@gmail.com",
                            Hash = "admin",
                            LastName = "Admin",
                            Login = "admin",
                            Name = "Admin",
                            Password = "$2a$11$7/FMs7y8r8xhyERp/Axi/.6Xk.6a.Tsrchvpv.tysMXv8r8utFvIu",
                            RoleId = 1
                        },
                        new
                        {
                            Id = 2,
                            CreatedAt = new DateTime(2024, 9, 23, 18, 24, 21, 218, DateTimeKind.Local).AddTicks(1365),
                            Hash = "",
                            LastName = "Hutmustrz",
                            Login = "",
                            Name = "Przykładowy",
                        ...
                        {
                            Id = 3,
                            CreatedAt = new DateTime(2024, 9, 23, 18, 24, 21, 218, DateTimeKind.Local).AddTicks(1422),
                            Hash = "",
                            LastName = "Hutnik",
                            Login = "",
                            Name = "Przykładowy",
